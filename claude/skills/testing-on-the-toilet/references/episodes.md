...
## Structure, data, assertions, names
...
- [Simulating Time in jsUnit Tests](https://testing.googleblog.com/2008/10/tott-simulating-time-in-jsunit-tests.html) (same idea: [2007-03-29](https://testing.googleblog.com/2007/03/javascript-simulating-time-in-jsunit.html))
...
## Testability of production (seams)
