...
function _git_behind_upstream
    test (git rev-list --right-only --count HEAD...@"{u}") -gt 0
end

function _git_ahead_of_upstream
    test (git rev-list --left-only --count HEAD...@"{u}") -gt 0
end
...
function fish_prompt
    ...
    _print_in_color "\n"(_pwd_with_tilde) 50565b

    set fish_color_command white
    set fish_color_param magneta
    set fish_color_error white
    set fish_color_host white
    set fish_color_redirection white
    set fish_pager_color_completion white
    set fish_color_normal cyan
    set fish_color_autosuggestion 555 green
    set fish_color_valid_path green

    if _in_git_directory
        _print_in_color " "(_git_branch_name_or_revision) blue
        _print_in_color (_git_dirty_status) 777
